...
{
    public class TicTacToeJudge : IJudge<TicTacToeState, TicTacToeMove, TicTacToePlayer, TicTacToeSummary, TicTacToeAction>
    {
        ...
        public TicTacToeState SetStartState(TicTacToePlayer[] players)
        {
            if (players.Length != 2)
